...
import { Component, ElementRef, QueryList, ViewChildren, ChangeDetectorRef, ChangeDetectionStrategy, OnDestroy } from '@angular/core';
...
import { combineLatest, Subscription, Subject, takeUntil } from 'rxjs';
...
type NavItem = {
  ...
  path?: string;
  new?: boolean;
  subItems?: { nameKey?: string; name?: string; path: string; pro?: boolean; new?: boolean }[];
};
...
export class AppSidebarComponent implements OnDestroy {
  ...
  navItems: NavItem[] = [
    {
      ...
      subItems: [
        { nameKey: "sidebar.ecommerce", path: "/" },
      ],
    },
    {
    ...
    },
    {
      ...
      subItems: [
        { nameKey: "sidebar.formElements", path: "/form-elements", pro: false }
      ],
    },
    {
      ...
      subItems: [
        { nameKey: "sidebar.basicTables", path: "/basic-tables", pro: false },
      ],
    },
    {
  ...
  othersItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { nameKey: "sidebar.avatars", path: "/avatars", pro: false },
  ...
  constructor(
    ...
    this.ensureI18nInitialized();
  }

  private async ensureI18nInitialized(): Promise<void> {
